...
//go:wasmimport [export]hayride:wit-examples/foo@0.0.1 [resource-new]foo
//go:noescape
func wasmimport_FooResourceNew(rep0 uint32) (result0 uint32)

//go:wasmimport [export]hayride:wit-examples/foo@0.0.1 [resource-rep]foo
//go:noescape
func wasmimport_FooResourceRep(self0 uint32) (result0 uint32)

//go:wasmimport [export]hayride:wit-examples/foo@0.0.1 [resource-drop]foo
//go:noescape
func wasmimport_FooResourceDrop(self0 uint32)

//go:wasmexport hayride:wit-examples/foo@0.0.1#[dtor]foo
//export hayride:wit-examples/foo@0.0.1#[dtor]foo
